...
- (BOOL)isValidatePassword{
    NSString* const PSD = @"^[a-zA-Z0-9]{6,20}$";
    NSPredicate* predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", PSD];
    return [predicate evaluateWithObject:self];
}
...
- (BOOL) isValidPrice{
    NSString *pattern = @"^[0-9]+[.]|[0-9]+([.][0-9]{0,2})?$";
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", pattern];
    return [predicate evaluateWithObject:self];
}
...
- (BOOL) isValidBankCardNumber {
    NSString* const BANKCARD = @"^([1-9]{1})(\\d{15}|\\d{17}|\\d{18})$";
